...
export {string_hash_code, hex_hash, store_hex, get_hex, add_hex_pos_to,     hexmap_wraparound_neighbors, 
    hexmap_values, hexmap_neighbors, hex_array_to_map_reducer} from './storage';
export { OffsetCoord,
    qoffset_from_cube,
    qoffset_to_cube,
    roffset_from_cube,
